...
TPCHTableGenerator::TPCHTableGenerator(float scale_factor, const std::shared_ptr<BenchmarkConfig>& benchmark_config)
    : AbstractTableGenerator(benchmark_config), _scale_factor(scale_factor) { std::cout << "## scale factor is " << _scale_factor
    << ", parameter is " << scale_factor << std::endl;}
